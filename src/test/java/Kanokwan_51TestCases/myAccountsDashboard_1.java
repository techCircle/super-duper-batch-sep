...
public class myAccountsDashboard_1 {
	...
	public void myAccountsDashboard() throws InterruptedException {
		...
		registerEmail.sendKeys("tiew219abc@gmail.com");
		...
		//9) User must view Dashboard of the site
		 	...
		 	String actualText = driver.findElement(By.xpath("//*[@id=\"page-36\"]/div/div[1]/nav/ul/li[1]/a")).getText();
			...
			System.out.println("Dashboard Home Page");
