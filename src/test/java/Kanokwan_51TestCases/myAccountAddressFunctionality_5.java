...
public class myAccountAddressFunctionality_5 {
...
WebDriver driver;
	...
	@Test
	public void myAccountAddressFunctionality() throws InterruptedException {
		...
		registerEmail.sendKeys("tiew604abc@gmail.com");
		...
		//10) User must view billing address and ship address
		 ...
		 String actualText = driver.findElement(By.xpath("//*[@id=\"page-36\"]/div/div[1]/div/p[2]")).getText();
		...
		System.out.println("User must view billing address and ship address");
