...
public class homepageArrivalsImageDescription_4 {
	...
	public void arrivalsImageDescription() throws InterruptedException {
     ...
     //9) Image should be click able and should navigate to next page where user can add that book to his basket
 		...
 		//11) There should be a description regarding that book the user clicked on
	        ...
	        String expectedText4 = driver.findElement(By.xpath("//*[@id='tab-description']")).getText();
	        
	        Assert.assertTrue(expectedText4.contains("Product Description"));
	        
	        System.out.println("Product Description picture1 completed");
	        
	        //Use Thread. Sleep :  while performing Selenium test automation, 
	        //it will stop the execution of the script for the time specified in the script, 
	        //irrespective of the fact that the element on the web page has been found.
	      ...
	      driver.findElement(By.xpath("//*[@id='text-22-sub_row_1-0-2-1-0']")).click();
	      driver.findElement(By.xpath("//*[@id=\"product-163\"]/div[3]/ul/li[1]")).click();
	        
	        String expectedText5 = driver.findElement(By.xpath("//*[@id=\"tab-description\"]/h2")).getText();
	        
	        Assert.assertTrue(expectedText5.contains("Product Description"));
	        
	        System.out.println("Product Description picture2 completed");
	      ...
	      //picture 3
	         ...
	         String expectedText6 = driver.findElement(By.xpath("//*[@id=\"tab-description\"]/h2")).getText();
	         
	         Assert.assertTrue(expectedText6.contains("Product Description"));
	         
	         System.out.println("Product Description picture3 completed");
