...
public class shopSortDefaultSortingHighToLowItem_7 {
...
WebDriver driver;
	...
	public void setUp() {
      ...
      //To maximize the browser
		...
		@Test
		public void sortDefaultSortingHighToLowItem() throws InterruptedException {
			...
			dropPopularity.selectByVisibleText("Sort by price: high to low");
			...
			System.out.println("Default Sorting by Price: High to Low" +" : "+"User can view the popular products only");
