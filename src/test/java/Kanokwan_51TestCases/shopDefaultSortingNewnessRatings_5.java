...
public class shopDefaultSortingNewnessRatings_5 {
...
WebDriver driver;
	...
	public void setUp() {
      ...
      //To maximize the browser
		...
		@Test
		public void shopDefaultSortingNewnessRatings() throws InterruptedException {
			...
			dropPopularity.selectByVisibleText("Sort by newness");
			...
			System.out.println("Default Sorting by Newness" +" : "+"User can view the popular products only");
