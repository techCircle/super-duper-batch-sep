...
public class shopDefaultSortingLowToHighItem_6 {
...
WebDriver driver;
	...
	public void setUp() {
      ...
      //To maximize the browser
		...
		@Test
		public void shopDefaultSortingLowToHighItem() throws InterruptedException {
			...
			dropPopularity.selectByVisibleText("Sort by price: low to high");
			...
			System.out.println("Default Sorting by Price: Low to High" +" : "+"User can view the popular products only");
