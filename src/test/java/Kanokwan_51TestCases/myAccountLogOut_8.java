...
public class myAccountLogOut_8 {
...
WebDriver driver;
	...
	@Test
	public void myAccountLogOut() throws InterruptedException {
		...
		registerEmail.sendKeys("tiew905abc@gmail.com");
		...
		WebElement logOutButton = driver.findElement(By.xpath("//*[@id=\"page-36\"]/div/div[1]/div/p[1]/a"));
		logOutButton.click();
		...
		String actualText = driver.findElement(By.xpath("//*[@id=\"customer_login\"]/div[2]/h2")).getText();
		...
		System.out.println("User Successful to Log Out");
