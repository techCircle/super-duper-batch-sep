...
public class shopAddToBasketViewFunctionality_10 {
...
Select select;
	...
	public void setUp() {
      ...
      //To maximize the browser
		...
		@Test
		public void shopAddToBasketViewFunctionality() throws InterruptedException{
		...
		WebElement addButton = driver.findElement(By.xpath("//*[@id=\"content\"]/ul/li[2]/a[2]"));
		addButton.click();
		...
		zipCode.sendKeys("105401");
		
		Thread.sleep(3000);
		
		//Payment
		WebElement payMent = driver.findElement(By.xpath("//*[@id=\"payment_method_bacs\"]"));
		payMent.click();
