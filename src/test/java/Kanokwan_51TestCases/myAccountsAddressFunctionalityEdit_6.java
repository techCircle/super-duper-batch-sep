...
public class myAccountsAddressFunctionalityEdit_6 {
...
WebDriver driver;
	...
	@Test
	public void myAccountsAddressFunctionalityEdit() throws InterruptedException {
		...
		registerEmail.sendKeys("tiew704abc@gmail.com");
		...
		WebElement addressLink = driver.findElement(By.xpath("//*[@id=\"page-36\"]/div/div[1]/nav/ul/li[4]/a"));
		addressLink.click();
		
		//10) Click Edit on Shipping Address
		
		WebElement shippingAddress = driver.findElement(By.xpath("//*[@id=\"page-36\"]/div/div[1]/div/div/div[2]/header/a"));
		shippingAddress.click();
		
		//11) User can Edit Shipping address
		 String actualText = driver.findElement(By.xpath("//*[@id=\"page-36\"]/div/div[1]/div/form/h3")).getText();
		...
		System.out.println("User can Edit Shipping address");
