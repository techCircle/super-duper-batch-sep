...
public class shopDefaultSortingAverageRating_4 {
	...
	public void setUp() {
      ...
      //To maximize the browser
		...
		@Test
		public void shopDefaultSortingAverageRating() throws InterruptedException {
			...
			dropPopularity.selectByVisibleText("Sort by average rating");
			...
			System.out.println("Default Sorting by Average Rating" +" : "+"User can view the popular products only");
