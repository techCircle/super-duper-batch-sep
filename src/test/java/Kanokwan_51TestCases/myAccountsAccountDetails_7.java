...
public class myAccountsAccountDetails_7 {
...
WebDriver driver;
	...
	public void myAccountsAccountDetails() throws InterruptedException {
		...
		registerEmail.sendKeys("tiew804abc@gmail.com");
		...
		WebElement addressLink = driver.findElement(By.xpath("//*[@id=\"page-36\"]/div/div[1]/nav/ul/li[5]/a"));
		addressLink.click();
		
		//10) User can view account details where he can change his pasword also.
		
		 String actualText = driver.findElement(By.xpath("//*[@id=\"page-36\"]/div/div[1]/div/form")).getText();
		...
		System.out.println("User can view account details");
