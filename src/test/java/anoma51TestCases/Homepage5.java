...
public class Homepage5 {
	...
	public void ruby() {
		...
		String actualTxt = 
				BaseClass.driver.findElement(By.xpath("//*[contains(text(),'Selenium Ruby') and@class='product_title entry-title']")).getText();
...
//		Click on reviews tab for the book you clicked on.
		BaseClass.driver.findElement(By.xpath("//*[@class='reviews_tab']")).click();
//		There should be a review regarding that book the user clicked on
		String reviewsMsg = BaseClass.driver.findElement(By.id("reviews")).getText();
		Assert.assertTrue(reviewsMsg.contains("reviews"));
		 System.out.println(BaseClass.getProperty("text"));
	}
	...
	public void HTML() {
		...
		String actualTxt = 
				BaseClass.driver.findElement(By.xpath("//*[contains(text(),'Thinking in HTML') and@class='product_title entry-title']")).getText();
		System.out.println(actualTxt);
...
//		There should be a review regarding that book the user clicked on
	...
	public void javaScript() {
		...
		String actualTxt = 
				BaseClass.driver.findElement(By.xpath("//*[contains(text(),'Mastering JavaScript') and@class='product_title entry-title']")).getText();
		System.out.println(actualTxt);
