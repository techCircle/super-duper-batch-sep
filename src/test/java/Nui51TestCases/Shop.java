...
public class Shop {
	...
	public void addToBasketViewBasket() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"billing_first_name\"]")).sendKeys(NuiConfigurationProperties.getKeyValue("name"));
		driver.findElement(By.xpath("//*[@id=\"billing_last_name\"]")).sendKeys(NuiConfigurationProperties.getKeyValue("lastName"));
		driver.findElement(By.xpath("//*[@id=\"billing_email\"]")).sendKeys(NuiConfigurationProperties.getKeyValue("goodEmail"));
		driver.findElement(By.xpath("//*[@id=\"billing_phone\"]")).sendKeys(NuiConfigurationProperties.getKeyValue("phoneNumber"));

		driver.findElement(By.xpath("//*[@id=\"billing_address_1\"]")).sendKeys(NuiConfigurationProperties.getKeyValue("address"));
		driver.findElement(By.xpath("//*[@id=\"billing_city\"]")).sendKeys(NuiConfigurationProperties.getKeyValue("city"));
		...
		driver.findElement(By.xpath("//*[@id=\"billing_postcode\"]")).sendKeys(NuiConfigurationProperties.getKeyValue("zipcode"));
	...
	public void addToBasketViewBasketTax() throws InterruptedException, ParseException {
		...
		driver.findElement(By.xpath("//*[@id=\"username\"]")).sendKeys(NuiConfigurationProperties.getKeyValue("goodEmail"));
		
		driver.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys(NuiConfigurationProperties.getKeyValue("goodPassword"));
		Thread.sleep(4000);
